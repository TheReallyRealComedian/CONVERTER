...
- Implementation:
  ...
  - Polish-1 (P12 Filename-Format + P14 Download-Toast + DE-string-pass): ☐ not started
  - Polish-2 (P9 Drop-Zone-Loading-Indikation, M-effort, separater Cluster wegen `fetch`→XHR-Frage): ☐ not started, awaiting Oliver's call (echtes Upload-Progress oder ehrlicher single-phase)
