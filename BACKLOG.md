...
### 1. `F3-PICK` — F-3 Feature-Wahl + Inventur · P2 · S
...
### 5. `F-N…` — Folge-Wellen für Restfeatures · P2 · je L
...
### 6. `WAVE-CLOSE` — Strukturelles Closing · P3 · XS
