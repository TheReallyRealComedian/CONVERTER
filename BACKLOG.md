...
### 1. `CVE-DG` — Deepgram-SDK Major-Bump · P2 · L
...
### 2. `F3-PICK` — F-3 Feature-Wahl + Inventur · P2 · S
...
### 6. `F-N…` — Folge-Wellen für Restfeatures · P2 · je L
...
### 7. `WAVE-CLOSE` — Strukturelles Closing · P3 · XS
