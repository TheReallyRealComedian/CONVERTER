...
$P_{out}$(k) ∼ $k^{-\gamma_{out}}$    and    $P_{in}$(k) ∼ $k^{-\gamma_{in}}$.    (3)
...
| Network | Size | ⟨k⟩ | ℓ | $\ell_{rand}$ | C | $C_{rand}$ | Reference | Nr. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| LANL coauthorship | 52, 909 | 9.7 | 5.9 | 4.79 | 0.43 | 1.8 × 10⁻⁴ | Newman 2001a,b | 4 |
| MEDLINE coauthorship | 1, 520, 251 | 18.1 | 4.6 | 4.91 | 0.066 | 1.1 × 10⁻⁵ | Newman 2001a,b | 5 |
| SPIRES coauthorship | 56, 627 | 173 | 4.0 | 2.12 | 0.726 | 0.003 | Newman 2001a,b,c | 6 |
| NCSTRL coauthorship | 11, 994 | 3.59 | 9.7 | 7.34 | 0.496 | 3 × 10⁻⁴ | Newman 2001a,b | 7 |
| Math coauthorship | 70, 975 | 3.9 | 9.5 | 8.2 | 0.59 | 5.4 × 10⁻⁵ | Barabási *et al.* 2001 | 8 |
| Neurosci. coauthorship | 209, 293 | 11.5 | 6 | 5.01 | 0.76 | 5.5 × 10⁻⁵ | Barabási *et al.* 2001 | 9 |
...
| Network | Size | ⟨k⟩ | κ | $\gamma_{out}$ | $\gamma_{in}$ | $\ell_{real}$ | $\ell_{rand}$ | $\ell_{pow}$ | Reference | Nr. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| WWW | 325, 729 | 4.51 | 900 | 2.45 | 2.1 | 11.2 | 8.32 | 4.77 | Albert, Jeong, Barabási 1999 | 1 |
| WWW | 4 × 10⁷ | 7 |  | 2.38 | 2.1 |  |  |  | Kumar *et al.* 1999 | 2 |
| WWW | 2 × 10⁸ | 7.5 | 4, 000 | 2.72 | 2.1 | 16 | 8.85 | 7.61 | Broder *et al.* 2000 | 3 |
...
| Phone-call | 53 × 10⁶ | 3.16 |  | 2.1 | 2.1 |  |  |  | Aiello *et al.* 2000 | 18 |
